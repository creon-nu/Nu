...
bool CBasicKeyStore::AddKey(const CKey& key)
{
    ...
    {
        LOCK(cs_KeyStore);
        mapKeys[CBitcoinAddress(key.GetPubKey(), cUnit)] = make_pair(secret, fCompressed);
    }
    return true;
}
...
{
    {
        ...
        mapCryptedKeys[CBitcoinAddress(vchPubKey, cUnit)] = make_pair(vchPubKey, vchCryptedSecret);
    }
    return true;
}
