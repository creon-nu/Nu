...
BOOST_AUTO_TEST_CASE(sign)
{
    ...
    standardScripts[1].SetBitcoinAddress(key[1].GetPubKey(), 'S');
    standardScripts[2] << key[1].GetPubKey() << OP_CHECKSIG;
    standardScripts[3].SetBitcoinAddress(key[2].GetPubKey(), 'S');
...
BOOST_AUTO_TEST_CASE(set)
{
    ...
    CScript inner[4];
    inner[0].SetBitcoinAddress(key[0].GetPubKey(), 'S');
...
BOOST_AUTO_TEST_CASE(AreInputsStandard)
{
    ...
    CScript pay1; pay1.SetBitcoinAddress(key[0].GetPubKey(), 'S');
    ...
    CTransaction txTo;
    txTo.vout.resize(1);
    txTo.vout[0].scriptPubKey.SetBitcoinAddress(key[1].GetPubKey(), 'S');
    ...
    txToNonStd.vout[0].scriptPubKey.SetBitcoinAddress(key[1].GetPubKey(), 'S');
